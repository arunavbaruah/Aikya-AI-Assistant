...
import mute_icon from './mute_icon.jpg'  // Your mute icon
import volume_icon from './volume_icon.png'  // You'll need to add this speaker icon
...
export const assets = {
    ...
    send_icon,
    gemini_icon,
    volume_mute_icon: mute_icon,  // Using your mute_icon.jpg
    volume_icon,  // Regular speaker icon
    news_icon,
}